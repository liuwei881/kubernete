define(['angular'], function (angular) {
   ...
   */
  angular.module('zCloudApp.controllers.AppServerCtrl', ['highcharts-ng'])
    .controller('AppServerCtrl', function (AppService, $scope, $state, $modal,Syncservice) {
      this.awesomeThings = [
        'HTML5 Boilerplate',
        'AngularJS',
        'Karma'
        ...
        $scope.sendReq = function(id, val){
         AppService.post('/api/app/rc/' + id, {"rc": val}).then(function(result){
            result.data;
         });
        };
